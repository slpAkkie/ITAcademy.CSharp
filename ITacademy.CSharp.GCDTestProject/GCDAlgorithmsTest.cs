...
namespace ITacademy.CSharp.GCDTestProject
{
    ...
    public class GCDAlgorithmsTest
    {
        ...
        public void FindGCDEuclid3Num()
        {
            ...
            int expected = 86;
            int actual;
            actual = GCDAlgorithms.GCDAlgorithms.FindGCDEuclid(a, b, c);
        ...
        public void FindGCDEuclid4Num()
        {
            ...
            int expected = 2;
            int actual;
            actual = GCDAlgorithms.GCDAlgorithms.FindGCDEuclid(a, b, c, d);
        ...
        public void FindGCDEuclid5Num()
        {
            ...
            int expected = 2;
            int actual;
            actual = GCDAlgorithms.GCDAlgorithms.FindGCDEuclid(a, b, c, d, e);

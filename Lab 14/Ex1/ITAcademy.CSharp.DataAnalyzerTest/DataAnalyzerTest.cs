using ITAcademy.CSharp.StressDataAnalyzer;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using System;
using System.Linq;
using ITAcademy.CSharp.StressTestResult;
using System.Collections.Generic;

namespace ITAcademy.CSharp.StressDataAnalyzerTest
{
    /// <summary>
    ...
    public class DataAnalyzerTest
    {
        ...
        public void CreateQueryandFormatResultsTest()
        {
            ...
            for (int testCount = 0; testCount < testQueryCriteria.GetLength(0); testCount++)
            {
                ...
                IEnumerable<StressTestResult.TestResult> actual = target.CreateQuery(dateStart, dateEnd, temperatureStart, temperatureEnd, appliedStressStart, appliedStressEnd, deflectionStart, deflectionEnd);
